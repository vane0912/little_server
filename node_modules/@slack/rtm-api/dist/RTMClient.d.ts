...
import { type RetryOptions, type RTMConnectArguments, type RTMStartArguments, type TLSOptions, type WebAPICallResult, WebClient } from '@slack/web-api';
...
export declare class RTMClient extends EventEmitter {
    ...
    addOutgoingEvent(awaitReply: false, type: string, body?: Record<string, unknown>): Promise<undefined>;
    /**
